...
<title>管理员登录 - 川农大公共资源管理品台</title>
	...
	<script src="<%= request.getContextPath() %>/static/back/js/base/adminlogin.js" type="text/javascript" charset="utf-8"></script>
					...
					<form action="#" method="post">
						...
						<div class="form-group form-actions">
							...
							<div class="col-xs-4 col-xs-offset-4 ">
								<button type="button" onclick="adminlogin('<%= request.getContextPath() %>/admin/loginin')" class="btn btn-sm btn-info"><span class="glyphicon glyphicon-off"></span> 登录</button>
							</div>
