...
<html>
	...
	<body>
			...
			<div class="accordion-group">
				...
				<div id="collapseTwo" class="accordion-body collapse" style="height: 0px; ">
					<ul class="nav menu">
						...
						<li class="active"><a href="returingapply.html" style="color: green;"><span class="glyphicon glyphicon-shopping-cart"></span> 归还申请</a></li>
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel panel-heading">
							<button class="btn btn-primary" onclick="returnapply()" name="consent" disabled="disabled">同意归还</button>
						</div>
		...
		<script src="<%= request.getContextPath() %>/static/back/js/base/returingapply.js" type="text/javascript" charset="utf-8"></script>
	</body>
</html>
