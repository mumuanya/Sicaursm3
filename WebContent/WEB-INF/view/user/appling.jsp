...
<html>
	...
	<body>
			...
			<div class="accordion-group">
				...
				<div id="collapseTwo" class="accordion-body collapse" style="height: 0px; ">
					<ul class="nav menu">
						...
						<li class="active"><a href="appling" style="color: green;"><span class="glyphicon glyphicon-shopping-cart"></span>正在审核中</a></li>
					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<table data-toggle="table"	id="applingtable" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-pagination="true" data-sort-name="name" data-sort-order="desc">
									<thead>
										<tr>
		...
		<script src="<%= request.getContextPath() %>/static/front/js/base/appling.js" type="text/javascript" charset="utf-8"></script>
	</body>
</html>
