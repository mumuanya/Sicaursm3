...
<html>
	...
	<body>
					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-body">
								<table data-toggle="table"	id="filedtable" data-pagination="true" data-search="true" data-show-refresh="true">
									<thead>
										<tr>
		...
		<script src="<%= request.getContextPath() %>/static/front/js/base/field.js" type="text/javascript" charset="utf-8"></script>
	</body>
</html>
